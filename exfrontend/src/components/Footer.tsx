const Footer = () => {
    return(
        <section className="pt-16 pb-7 bg-gray-700 ">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <a href="https://pagedone.io/" className="py-1.5 flex items-center font-bold text-gray-200 space-x-2">
            <img src="http://localhost:5173/seitastic.png" alt="Seitastic Logo" className="h-20 w-auto" />
            <span className="text-[30px]">Seitastic</span>
      </a>

        <ul className="flex flex-col sm:flex-row items-center gap-5 sm:gap-12">
          <li><a href="jaascript:;"
              className="text-lg font-semibold text-gray-200 transition-all duration-300 hover:text-red-500 focus-within:text-indigo-600 focus-within:outline-0">Seitastic</a>
          </li>
          <li><a href="jaascript:;"
              className="text-lg font-semibold text-gray-200 transition-all duration-300 hover:text-red-500 focus-within:text-red-500 focus-within:outline-0">Courses</a>
          </li>
          <li><a href="jaascript:;"
              className="text-lg font-semibold text-gray-200 transition-all duration-300 hover:text-red-500 focus-within:text-red-500 focus-within:outline-0">Blogs</a>
          </li>
        </ul>
      </div>
      <div className="pt-7 flex flex-col min-[520px]:flex-row items-center justify-between gap-6">
        <span className="text-sm font-normal text-gray-500">©<a href="https://pagedone.io/">seitastic</a> 2024, All rights reserved.</span>
        <div className="flex items-center gap-4">
          <a href="javascript:;"
            className="border border-gray-300 p-2 rounded-full aspect-square text-gray-200 transition-all duration-500 hover:text-red-500 hover:border-red-500 focus-within:outline-0 focus-within:text-red-500 focus-within:border-red-500">
          ...
          <a href="javascript:;"
            className="border border-gray-300 p-2 rounded-full aspect-square text-gray-200 transition-all duration-500 hover:text-red-500 hover:border-red-500 focus-within:outline-0 focus-within:text-red-500 focus-within:border-red-500">
            <svg xmlns="http://ww w.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
